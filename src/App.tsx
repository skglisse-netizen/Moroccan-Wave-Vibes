...
export default function App() {
  ...
  const renderContent = () => {
    switch (activeTab) {
      case 'dashboard': return <DashboardView stats={stats} onUpdate={fetchStats} user={user} isDarkMode={isDarkMode} />;
      ...
      default: return <DashboardView stats={stats} onUpdate={fetchStats} user={user} />;
    }
  };
