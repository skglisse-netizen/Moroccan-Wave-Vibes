  ...
  return (
    <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  ...
                  <Select
                    ...
                    value={configForm.conseils_layout}
                    onChange={(e) => setConfigForm({ ...configForm, conseils_layout: e.target.value })}
                    options={[
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
        {paginatedData.map(c => (
          <Card key={c.id} className="p-4 relative group overflow-hidden border-slate-100 hover:shadow-lg transition-all">
