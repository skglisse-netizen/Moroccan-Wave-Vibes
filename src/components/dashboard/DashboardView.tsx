...
export function DashboardView({ stats, onUpdate, user, isDarkMode }: { stats: DashboardStats | null, onUpdate: (params?: any) => void, user: User, isDarkMode?: boolean }) {
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 bg-white/40 backdrop-blur-md p-3 rounded-2xl border border-slate-200/50 shadow-sm relative overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-0.5">
                        ...
                        <div className="flex items-center gap-1.5 px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded-lg text-[10px] font-black uppercase tracking-widest border border-indigo-200 shadow-sm">
